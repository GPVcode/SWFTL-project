  ...
  return (
    <div>
        ...
        <p className='our-story'>
            In the heart of the bustling digital world, a vision was born — a vision that sought to transform the way we engage with learning and comprehension. It all began with a fervent passion for education, a deep love for technology, and an unyielding determination to make a lasting impact.
            <br/><br/>
            As the creator, I found myself captivated by the intricate dance between words on a page and the minds that bring them to life. The potential of a well-composed passage to inspire, educate, and spark curiosity never ceased to amaze me.
            <br/><br/>
            One day, amid a surge of inspiration and excitement, the vision for Swift Learnings, our reading comprehension app, crystallized. It was to be a platform that not only delivered educational content but did so in a manner that engaged, challenged, and encouraged learners to truly grasp the essence of what they read.
            <br/><br/>
